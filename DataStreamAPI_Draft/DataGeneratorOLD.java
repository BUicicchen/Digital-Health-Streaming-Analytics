...
public class DataGeneratorOLD<T> implements ParallelSourceFunction<T> {
    ...
    public int randSize;
    public DataGeneratorOLD(Integer patientID, Integer deviceID, String deviceType, boolean isFluctuate, int sleepTime) {
    ...
    public DataGeneratorOLD(Integer patientID, Integer deviceID, String deviceType, boolean isFluctuate,
                            int sleepTime, int randSize) {
        this.patientID = patientID;
        this.deviceID = deviceID;
        this.deviceType = deviceType;
        timestampStart = 0;
