...
public class Q1CoProcessFunction<IN1, IN2> extends KeyedCoProcessFunction<Integer, IN1, IN2, String> {
    ...
    // constructor
    public Q1CoProcessFunction(Map<String, Float[]> newSessionThreshMap, String[] newAttrNames, int purgeThreshold, boolean isTrackPrev) {
    ...
    @Override
    public void processElement1(IN1 data1, Context ctx, Collector<String> out) throws Exception {
    ...
    @Override
    public void processElement2(IN2 data2, Context ctx, Collector<String> out) throws Exception {
