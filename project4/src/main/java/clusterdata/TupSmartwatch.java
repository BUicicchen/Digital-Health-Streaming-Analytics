...
public class TupSmartwatch extends TupDevice {
    ...
    protected static final String deviceName = "Smartwatch";
    protected static final String attrNameStepsSinceLast = "steps since last";
    protected static final String attrNameMeanHeartRate = "mean heart rate";
    // default constructor
    ...
    public String toString() {
        return (deviceName + " " + super.toString() + ", " + attrNameStepsSinceLast + ": " + stepsSinceLast +
                ", " + attrNameMeanHeartRate + ": " + meanHeartRate);
    }
}
